    ...
    <main className="min-h-screen bg-[#f3f1ed] text-[#1f1f1f]">
      ...
      <section className="relative min-h-[82vh] overflow-hidden">
        <div
          ...
          style={{ backgroundImage: "url('/ledarskap-2026.png')" }}
        />
      </section>
      ...
      <section className="bg-[#f3f1ed] px-6 md:px-12 lg:px-20 pt-12 md:pt-16 pb-24 md:pb-28">
        <div className="max-w-6xl mx-auto">
          <div className="mb-10 md:mb-12">
            <p
              className={`${firaSans.className} text-[13px] uppercase tracking-[0.24em] text-[#a27a26] mb-4`}
            ...
            {hallOfFame.map((item) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[1rem] md:text-[1.06rem] leading-[1.85] text-[#2c2c2c]">
                    {item.summary}
                  </p>
                </div>
              </div>
