      ...
      <section className="bg-[#f3f1ed] px-5 md:px-12 lg:px-20 pt-14 md:pt-28 pb-20 md:pb-28">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mx-auto mb-10 max-w-4xl text-center md:mb-14">
            ...
            <p className="mx-auto max-w-[23rem] whitespace-pre-line text-[1.06rem] italic leading-[1.5] text-[#5f5a52] sm:max-w-[31rem] sm:text-[1.14rem] md:max-w-none md:text-[1.4rem]">
